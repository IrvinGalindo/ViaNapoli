        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
            ...
            <div class="dropdown-divider"></div>
              ...
              $rg=mysqli_query($conexion,"SELECT concat(t.nombre,' ',t.paterno) as nombre,DATE_FORMAT(a.hora,'%H:%i') as hora,idTrabajador from trabajadores t,auth a where t.idTrabajador=a.numTrabajador and a.hora<curtime() and 
